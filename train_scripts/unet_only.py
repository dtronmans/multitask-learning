...
if __name__ == "__main__":
    ...
    train_dataset = MedicalImageDataset("/eREDACTED", split="train", transform=transform,
                                        mask_only=True)
    val_dataset = MedicalImageDataset("/REDACTED", split="val", transform=transform, mask_only=True)
